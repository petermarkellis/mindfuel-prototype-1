...
-- Avatar filenames map to static assets in /public/avatars/
...
COMMENT ON COLUMN users.avatar_url IS 'Avatar image filename in /public/avatars/. Format: Gender_Number.webp';
